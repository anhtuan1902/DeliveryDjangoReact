    ...
    return (
        <div className='sidebar p-2 bg-white'>
            ...
            <div className='list-group list-group-flush'>
                <Link className='list-group-item py-2 bg-white' to='/'>
                    <BsNewspaper className='fs-4 me-3' />
                    <span className='fs-4'>Trang chủ</span>
                </Link>
                <Link className='list-group-item py-2 bg-white' to='/shippers'>
                    <BsNewspaper className='fs-4 me-3' />
                    <span className='fs-4'>Nhân viên</span>
                </Link>
                <Link className='list-group-item py-2 bg-white' to='/orders'>
                    <BsNewspaper className='fs-4 me-3' />
                    <span className='fs-4'>Đơn hàng</span>
                </Link>
                {user.user_role === 'ADMIN_ROLE' ? <><Link className='list-group-item py-2 bg-white' to='/admin/discounts'>
                    <BsNewspaper className='fs-4 me-3' />
                    <span className='fs-4'>Quản trị mã giảm</span>
                </Link>
                    <Link className='list-group-item py-2 bg-white' to='/admin/shippers'>
                        <BsNewspaper className='fs-4 me-3 ' />
